	...
	<div class="page-width-1 page-left">
		<div
			...
			<div class="intro-left tm-bg-dark">
				...
				<p class="mb-4">
					CatchMind 퀴즈의 기본형식은 그림 판에 그림으로 그려서 게시글에 업로드하면 회원들이 댓글로 맞추는 그림퀴즈입니다.<br>
					퀴즈로 무한한 창의적 발상과 상상력이 발휘되는 매우 교육적인 퀴즈의 형태입니다.
				</p>
				<p class="mb-0">Catch Mind!</p>
			</div>
		...
		<div class="text-center">
			...
			<button class="btn w-btn-neon2 tm-intro-btn tm-page-link"
				type="button"
				onclick="location.href='${pageContext.request.contextPath }/board/board_list.board'">
				QUIZ 풀러가기</button>
		</div>
	</div>
</li>
